...
- [x]  B. A redirection technique called pharming.
...
- [x]  C. Business email compromise (BEC)
...
- [x]  B. A cluster of honeypots designed to simulate a full network  
...
- [x]  C. It is completely isolated from other networks  
